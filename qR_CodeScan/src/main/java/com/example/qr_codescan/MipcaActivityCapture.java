...
/**
 * 原始类，使用时要复制(或者继承)此类做修改
 */
public class MipcaActivityCapture extends Activity implements Callback, View.OnClickListener {

    public final static String TITLE = "titleStr";
    public final static String RESULTSTRING = "result";
...
//        inactivityTimer = new InactivityTimer(MipcaActivityCapture.this);
        ...
        Acp.getInstance(this).request(
                new AcpOptions.Builder().setPermissions(
                        Manifest.permission.CAMERA, Manifest.permission.VIBRATE, Manifest.permission.FLASHLIGHT,
                        "android.hardware.camera", "android.hardware.camera.autofocus").build(),
                new AcpListener() {
                    @Override
                    public void onGranted() {
                        ...
                        mButtonBack.setOnClickListener(MipcaActivityCapture.this);
                        hasSurface = false;
                        inactivityTimer = new InactivityTimer(MipcaActivityCapture.this);
                        ImageButton mImageButton = (ImageButton) findViewById(R.id.button_function);
                        mImageButton.setOnClickListener(MipcaActivityCapture.this);
                    }

                    @Override
                    public void onDenied(List<String> permissions) {
                        UIHelper.toastMessage(MipcaActivityCapture.this, permissions.toString() + "权限拒绝");
                        finish();
                    }
                });
    ...
    private void onResultHandler(String resultString, Bitmap bitmap) {
        ...
        if (onResultBefore(resultString)) {

            Intent resultIntent = new Intent();
            Bundle bundle = new Bundle();
            bundle.putString(RESULTSTRING, resultString);
//		    bundle.putParcelable("bitmap", bitmap);//图片太大时会报错
