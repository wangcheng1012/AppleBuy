 ...
 * 草稿 代理
 */
public class CaoGaoDelegate {
    private final TabLayoutFragment tabLayoutFragment;

    public CaoGaoDelegate(TabLayoutFragment tabLayoutFragment) {
        this.tabLayoutFragment = tabLayoutFragment;
    }

    void init(ViewHolder viewHolder, Coupon item, SWRVFragment<Coupon> swrvFragment) {
        ...
        onClick(item, swrvFragment, view1, view2);
    }

    private void onClick(final Coupon item, final SWRVFragment<Coupon> swrvFragment, TextView view1, TextView view2) {
        //提交审核
        view1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                tabLayoutFragment.setCur(swrvFragment);
    ...
    void couponBack(Coupon coupon) {
        ...
        GoToHelp.goResult(tabLayoutFragment.getActivity(), YouHuiAddActivity.class, tabLayoutFragment.requestcode_itemClick, bundle);
    }
}