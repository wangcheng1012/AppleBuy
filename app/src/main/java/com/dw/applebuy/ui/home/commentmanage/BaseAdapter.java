...
public class BaseAdapter<T extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<T> {
    ...
    public List<CommentListBean.ImagesBean> listDatas;//数据源
    ...
    public BaseAdapter(Context context, List<CommentListBean.ImagesBean> listDatas) {
     ...
     */
    public BaseAdapter(Context context, List<CommentListBean.ImagesBean> listDatas, OnViewClickListener onViewClickListener) {
        init(context,listDatas);
     ...
     * @param listDatas
     */
    void init(Context context, List<CommentListBean.ImagesBean> listDatas){
